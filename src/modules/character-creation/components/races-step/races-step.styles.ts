...
export const RaceCardsGrid = styled.section`
  display: grid;
  grid-template-columns: repeat(auto-fill, minmax(170px, 1fr));
  gap: 0.85rem;
`;

export const RaceCardButton = styled.button<{ isSelected: boolean }>`
  display: flex;
  flex-direction: column;
...
export const RaceCardImageWrapper = styled.div`
  width: 100%;
...
export const RaceCardTitle = styled.h2`
  margin: 0;
  font-size: 0.98rem;
  line-height: 1.2;
...
export const RaceCardDescription = styled.p`
  margin: 0;
  font-size: 0.81rem;
  line-height: 1.45;
  color: ${(props) =>
...
export const SubraceSection = styled.section`
  display: flex;
  flex-direction: column;
  gap: 0.65rem;
  border: 1px solid ${(props) => props.theme.border};
...
export const SubraceTitle = styled.h3`
  margin: 0;
  font-size: 1rem;
  color: ${(props) => props.theme["primary-text-color"]};
`;

export const SubraceHelperText = styled.p`
  margin: 0;
  font-size: 0.84rem;
  color: ${(props) =>
    props.theme.foreground === "#fff" ? "#d1d5db" : "#475569"};
...
export const SubraceGrid = styled.div`
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(150px, 1fr));
  gap: 0.55rem;
`;

export const SubraceButton = styled.button<{ isSelected: boolean }>`
  min-height: 2.4rem;
  ...
  background-color: ${(props) =>
    props.isSelected ? props.theme["surface-accent"] : props.theme.surface};
  color: ${(props) =>
    props.isSelected ? props.theme["green-500"] : props.theme["primary-text-color"]};
  font-size: 0.83rem;
  font-weight: 600;
  text-align: left;
  cursor: pointer;
...
export const SelectedInfoParagraph = styled.p`
  margin: 0;
  font-size: 0.86rem;
  line-height: 1.45;
  color: ${(props) =>
